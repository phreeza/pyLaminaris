...
ax2 = plt.subplot(2,3,2,sharey=ax)
for label in ax2.get_yticklabels():
    label.set_visible(False)
plt.plot(times,-fted/100 + depths)
plt.xlim((0,4))
#plt.ylim((0,1600))
plt.gca().invert_yaxis()
plt.grid()
...
ax3 = plt.subplot(2,3,3,sharey=ax)
for label in ax3.get_yticklabels():
    label.set_visible(False)
plt.plot(times,-fted_hp/100 + depths)
plt.xlim((0,4))
#plt.ylim((0,1600))
plt.gca().invert_yaxis()
plt.grid()
...
ax5 = plt.subplot(2,3,5,sharey=ax4,sharex=ax2)
for label in ax5.get_yticklabels():
    label.set_visible(False)
plt.plot(times*1000.,-fted[:,depth_index]/filt_scale + depths[depth_index])
plt.xlim((0,4))
plt.gca().invert_yaxis()
plt.ylim((1600,00))
plt.grid()
...
ax6 = plt.subplot(2,3,6,sharey=ax4,sharex=ax3)
for label in ax6.get_yticklabels():
    label.set_visible(False)

plt.plot(times*1000.,-fted_hp[:,depth_index]/filt_scale + depths[depth_index])
plt.xlim((0,4))
plt.gca().invert_yaxis()
plt.ylim((1600,00))
plt.grid()
...
plt.figtext(0.08 ,0.48,'D',fontsize=24)
plt.figtext(0.4,0.48,'E',fontsize=24)
